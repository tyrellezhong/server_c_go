-- ============================================================
-- otel_logs_json 表：基于官方 sqltemplates/logs_json_table.sql 手动管理
-- 使用 JSON 类型替代 Map，子列独立存储，IO 更高效
-- create_schema: false 时 exporter 只发 INSERT，不自动建表
-- ============================================================
CREATE DATABASE IF NOT EXISTS otel;

CREATE TABLE IF NOT EXISTS otel.otel_logs_json (
...
-- ServiceName 次之，TimestampTime 做时间范围收敛，Timestamp 保证纳秒精度唯一性
