...
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_proto_5foption_2eproto_getter() {
  return &descriptor_table_proto_5foption_2eproto;
}
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "msg.Person.name"));
        } else
          goto handle_unusual;
        continue;
      // int32 age = 2;
